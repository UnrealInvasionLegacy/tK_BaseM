class SMPMercenary extends SMPMonster;
...
defaultproperties
{
     ...
     MyDamageType=Class'tK_BaseM.SMPMerceAmmoDamType'
     mTracerClass=Class'XEffects.Tracer'
     mTracerFreq=0.110000
     mTracerLen=0.800000
     SprayDamage=10
     SprayDamageMax=15
     RocketAmmoClass=Class'tK_BaseM.SMPMerceRocketAmmo'
     PunchDamage=20
     ...
     AmmunitionClass=Class'tK_BaseM.SMPMercenaryAmmo'
     ScoringValue=7
