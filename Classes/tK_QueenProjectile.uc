class tK_QueenProjectile extends SkaarjProjectile;
...
simulated function PostBeginPlay()
{
    ...
    {
        SparkleTrail = Spawn(class'tK_SkaarjSparkles', self);
...
simulated function ProcessTouch (Actor Other, vector HitLocation)
{
    ...
    else if ( tK_QueenProjectile(Other) == None || Other.bProjTarget )
    {
...
defaultproperties
{
     ...
     MyDamageType=Class'tK_BaseM.tK_DamTypeQueenProj'
