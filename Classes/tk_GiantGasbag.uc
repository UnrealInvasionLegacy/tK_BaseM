class tk_GiantGasbag extends tk_Gasbag;
...
{
    super.PostBeginPlay();
    MyAmmo.ProjectileClass = class'tk_GiantGasBagBelch';
}

function SpawnBelch()
{
    local tk_ChildGasbag G;
    ...
    {
        G = spawn(class'tk_ChildGasbag',self,,FireStart + (0.6 * CollisionRadius + class'tk_GiantGasbag'.default.CollisionRadius) * X);
        if (G != None)
        {
            G.ParentBag = self;
            numChildren++;
